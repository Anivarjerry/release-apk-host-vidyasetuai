...
fun AccountantDashboard(
    ...
    Column(
        ...
        DashboardWelcomeCard(
            userName = activeWs?.roleDisplayName ?: (if (isHindi) "लेखाकार" else "Accountant"),
            roleDisplayName = activeWs?.workspaceSubRole ?: (if (isHindi) "लेखाकार" else "Accountant"),
