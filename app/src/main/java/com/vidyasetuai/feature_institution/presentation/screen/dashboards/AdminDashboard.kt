...
fun AdminDashboard(
    ...
    Column(
        ...
        DashboardWelcomeCard(
            userName = activeWs?.roleDisplayName ?: (if (isHindi) "प्रशासक" else "Admin"),
            roleDisplayName = activeWs?.workspaceSubRole ?: (if (isHindi) "प्रशासक" else "Admin"),
        ...
        Box(
            ...
            Text(text = if (isHindi) "एडमिन डैशबोर्ड" else "Admin Dashboard")
        }
    }
}
