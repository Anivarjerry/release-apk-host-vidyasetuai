...
fun ClerkDashboard(
    ...
    Column(
        ...
        DashboardWelcomeCard(
            userName = activeWs?.roleDisplayName ?: (if (isHindi) "लिपिक" else "Clerk"),
            roleDisplayName = activeWs?.workspaceSubRole ?: (if (isHindi) "लिपिक" else "Clerk"),
        ...
        Box(
            ...
            Text(text = if (isHindi) "लिपिक डैशबोर्ड" else "Clerk Dashboard")
        }
    }
}
