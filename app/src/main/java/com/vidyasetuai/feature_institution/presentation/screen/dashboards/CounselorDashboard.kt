...
fun CounselorDashboard(
    ...
    Column(
        ...
        DashboardWelcomeCard(
            userName = activeWs?.roleDisplayName ?: (if (isHindi) "सलाहकार" else "Counselor"),
            roleDisplayName = activeWs?.workspaceSubRole ?: (if (isHindi) "सलाहकार" else "Counselor"),
        ...
        Box(
            ...
            Text(text = if (isHindi) "सलाहकार डैशबोर्ड" else "Counselor Dashboard")
        }
    }
}
