...
fun LibrarianDashboard(
    ...
    Column(
        ...
        DashboardWelcomeCard(
            userName = activeWs?.roleDisplayName ?: (if (isHindi) "पुस्तकालयाध्यक्ष" else "Librarian"),
            roleDisplayName = activeWs?.workspaceSubRole ?: (if (isHindi) "पुस्तकालयाध्यक्ष" else "Librarian"),
        ...
        Box(
            ...
            Text(text = if (isHindi) "पुस्तकालयाध्यक्ष डैशबोर्ड" else "Librarian Dashboard")
        }
    }
}
