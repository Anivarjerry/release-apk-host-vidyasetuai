...
fun NurseDashboard(
    ...
    Column(
        ...
        DashboardWelcomeCard(
            userName = activeWs?.roleDisplayName ?: (if (isHindi) "नर्स" else "Nurse"),
            roleDisplayName = activeWs?.workspaceSubRole ?: (if (isHindi) "नर्स" else "Nurse"),
        ...
        Box(
            ...
            Text(text = if (isHindi) "नर्स डैशबोर्ड" else "Nurse Dashboard")
        }
    }
}
