...
fun OfficeAssistantDashboard(
    ...
    Column(
        ...
        DashboardWelcomeCard(
            userName = activeWs?.roleDisplayName ?: (if (isHindi) "कार्यालय सहायक" else "Office Assistant"),
            roleDisplayName = activeWs?.workspaceSubRole ?: (if (isHindi) "कार्यालय सहायक" else "Office Assistant"),
        ...
        DashboardTodayLogsCard(
            role = activeWs?.role ?: "Office Assistant",
            isHindi = isHindi,
            isDark = isDark,
        ...
        Box(
            ...
            Text(text = if (isHindi) "कार्यालय सहायक डैशबोर्ड" else "Office Assistant Dashboard")
        }
    }
}
