...
fun PrincipalDashboard(
    ...
    Column(
        ...
        DashboardWelcomeCard(
            userName = activeWs?.roleDisplayName ?: (if (isHindi) "प्राचार्य" else "Principal"),
            roleDisplayName = activeWs?.workspaceSubRole ?: (if (isHindi) "प्राचार्य" else "Principal"),
        ...
        Box(
            ...
            Text(text = if (isHindi) "प्राचार्य डैशबोर्ड" else "Principal Dashboard")
        }
    }
}
