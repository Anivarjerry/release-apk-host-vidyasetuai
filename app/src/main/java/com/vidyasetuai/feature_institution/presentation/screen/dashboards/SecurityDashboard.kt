...
fun SecurityDashboard(
    ...
    Column(
        ...
        DashboardWelcomeCard(
            userName = activeWs?.roleDisplayName ?: (if (isHindi) "सुरक्षा गार्ड" else "Security Guard"),
            roleDisplayName = activeWs?.workspaceSubRole ?: (if (isHindi) "सुरक्षा गार्ड" else "Security Guard"),
        ...
        Box(
            ...
            Text(text = if (isHindi) "सुरक्षा डैशबोर्ड" else "Security Dashboard")
        }
    }
}
