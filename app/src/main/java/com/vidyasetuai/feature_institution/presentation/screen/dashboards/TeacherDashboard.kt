...
fun TeacherDashboard(
    ...
    Column(
        ...
        DashboardWelcomeCard(
            userName = activeWs?.roleDisplayName ?: (if (isHindi) "शिक्षक" else "Teacher"),
            roleDisplayName = activeWs?.workspaceSubRole ?: (if (isHindi) "शिक्षक" else "Teacher"),
