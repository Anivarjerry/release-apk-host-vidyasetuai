    ...
    Scaffold(
        topBar = {
            Column(modifier = Modifier.fillMaxWidth().background(backgroundColor)) {
                Row(
                    ...
                    Text(
                        text = if (isHindi) "टिप्पणी जोड़ें" else "Add Remark",
                        fontSize = 20.sp,
        ...
        Box(
            ...
            Column(
                ...
                Text(
                    text = if (isHindi) "टिप्पणी जोड़ें" else "Add New Remark",
                    fontSize = 18.sp,
                    fontWeight = FontWeight.Bold,
                    color = textColor
                )
                ...
                Text(
                    text = if (isHindi) 
                        "अभिभावक या छात्र के लिए नई टिप्पणी लिखने की सुविधा यहाँ उपलब्ध होगी।" 
                    else 
                        "The facility to write a new remark for a student or parent will be available here.",
                    fontSize = 14.sp,
                    color = subtitleColor,
